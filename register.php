...
<body>
    <div class="row-horizontal d-flex flex-column justify-content-center align-items-center">
        <div class="header mt-5">
            <h2 class="text-uppercase mt-5">Registrarse</h2>
        </div>
        <form method="post" action="register.php" class="mt-2">
            ...
            <div class="input-group">
                <button type="submit" class="btn btn-login mx-auto mt-2" name="reg_user">Registrate</button>
            </div>
            <p>
                Ya sos miembro? <a href="./login.php" class="text-decoration-none">Iniciar Sesión</a>
            </p>
        </form>
    </div>
</body>
